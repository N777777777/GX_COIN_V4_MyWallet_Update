      ...
      <main className="py-6 pb-24">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="account" className="mt-0">
            ...
            {/* TON Wallet Card - Added to TapGame.tsx */}
            <Card className="mobile-card bg-card/80 border-border/50 rounded-xl overflow-hidden animate-fade-in floating-card">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
                  <Wallet className="w-4 h-4 text-primary" />
                  {t('محفظة TON', 'TON Wallet')}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <Button 
          ...
          <TabsList className="fixed bottom-0 left-0 right-0 grid w-full grid-cols-7 h-20 gap-1 bg-card/95 p-2 border-t border-border/50 rounded-t-3xl z-50 animate-slide-in-right">
            ...
            <TabsTrigger value="wallet" className="flex flex-col items-center gap-2 p-2 rounded-full aspect-square data-[state=active]:bg-gradient-to-br data-[state=active]:from-primary data-[state=active]:to-primary/80 data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg transition-all duration-300 hover:scale-110 hover-scale border-2 border-transparent data-[state=active]:border-primary/20" onClick={playClickSound}>
