  ...
  public: {
    Tables: {
      ad_view_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_view_tracking_telegram_user_id_fkey"
      ...
      current_state_backup_before_july25_restore: {
        Row: {
          ...
          coins_current: number | null
          first_name: string | null
          id: string | null
          restore_reason: string | null
          telegram_id: number | null
          ton_balance_current: number | null
          username: string | null
        }
        Insert: {
          backup_timestamp?: string | null
      ...
      dex_liquidity_operations: {
        ...
        Relationships: [
          {
            foreignKeyName: "dex_liquidity_operations_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
      ...
      dex_pools: {
        Row: {
          ...
          pool_address: string
          price_token0: number | null
          price_token1: number | null
          reserve0: number
          reserve1: number
      ...
      dex_swaps: {
        ...
        Relationships: [
          {
            foreignKeyName: "dex_swaps_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "dex_pools"
            referencedColumns: ["id"]
      ...
      frozen_balances: {
        ...
        Relationships: [
          {
            foreignKeyName: "frozen_balances_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
      ...
      qualified_users: {
        ...
        Relationships: [
          {
            foreignKeyName: "qualified_users_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: true
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      security_violations: {
        ...
        Relationships: [
          {
            foreignKeyName: "security_violations_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      suspicious_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "suspicious_activities_resolved_by_fkey"
            columns: ["resolved_by"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "suspicious_activities_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      task_notifications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "task_notifications_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      timewall_qualification_progress: {
        Row: {
          completed_at: string | null
          created_at: string
      ...
      ton_balance_restore_24_july_backup: {
        Row: {
          coins_unchanged: number | null
          first_name: string | null
          id: string | null
          restore_reason: string | null
          restore_timestamp: string | null
          telegram_id: number | null
          ton_balance_after_restore: number | null
          ton_balance_before_restore: number | null
          username: string | null
        }
        Insert: {
      ...
      ton_balance_restore_26_july_23utc_backup: {
        Row: {
          coins_unchanged: number | null
          first_name: string | null
          id: string | null
          ...
          restore_timestamp: string | null
          telegram_id: number | null
          ton_balance_after_restore_26_23utc: number | null
          ton_balance_before_restore_26_23utc: number | null
          username: string | null
        }
        Insert: {
          coins_unchanged?: number | null
      ...
      ton_balance_restore_26_july_backup: {
        Row: {
          coins_unchanged: number | null
          first_name: string | null
          id: string | null
      ...
      ton_balance_restore_27_july_backup: {
        Row: {
          coins_unchanged: number | null
          first_name: string | null
          id: string | null
          ...
          restore_timestamp: string | null
          telegram_id: number | null
          ton_balance_after_restore_27: number | null
          ton_balance_before_restore_27: number | null
          username: string | null
        }
        Insert: {
          coins_unchanged?: number | null
      ...
      ton_withdrawals: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_ton_withdrawals_telegram_user"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      uid_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "uid_submissions_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
      ...
      user_balance_backup_20250727_v3: {
        Row: {
          ...
          id: string | null
          telegram_id: number | null
          ton_balance_after: number | null
          ton_balance_before: number | null
          updated_at: string | null
          username: string | null
        }
        Insert: {
      ...
      user_balance_backup_20250727_v4: {
        Row: {
          backup_created_at: string | null
          coins_after: number | null
          coins_before: number | null
      ...
      user_balance_backup_before_1am_egypt: {
        Row: {
          backup_created_at: string | null
          coins_current: number | null
          coins_reset: number | null
          created_at: string | null
          first_name: string | null
          telegram_id: number | null
          ton_balance_current: number | null
          ton_balance_reset: number | null
          username: string | null
        }
        Insert: {
          backup_created_at?: string | null
      ...
      user_balance_backup_reset_to_25_july: {
        Row: {
          coins_after_reset: number | null
          coins_before_reset: number | null
          first_name: string | null
          id: string | null
          reset_timestamp: string | null
          telegram_id: number | null
          ton_balance_after_reset: number | null
          ton_balance_before_reset: number | null
          username: string | null
        }
        Insert: {
          coins_after_reset?: number | null
      ...
      user_balance_final_restoration_backup: {
        Row: {
          coins_after_final_restore: number | null
          coins_before_final_restore: number | null
          first_name: string | null
          id: string | null
          restoration_timestamp: string | null
          telegram_id: number | null
          ton_balance_after_final_restore: number | null
          ton_balance_before_final_restore: number | null
          username: string | null
        }
        Insert: {
      ...
      user_task_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_task_participants_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "user_created_tasks"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      user_verification: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_verification_telegram_user_id_fkey"
            columns: ["telegram_user_id"]
            isOneToOne: false
            referencedRelation: "telegram_users"
            referencedColumns: ["id"]
