-- إنشاء جدول للقيمة السوقية العالمية
CREATE TABLE public.global_market_value (
...
-- إدراج قيمة أولية
INSERT INTO public.global_market_value (total_value) VALUES (0);
...
-- إنشاء RLS policies
ALTER TABLE public.global_market_value ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Anyone can view market value" 
ON public.global_market_value 
FOR SELECT 
USING (true);

CREATE POLICY "Service role can manage market value" 
ON public.global_market_value 
FOR ALL 
USING (true);