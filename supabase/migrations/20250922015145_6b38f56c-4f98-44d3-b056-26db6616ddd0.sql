-- CRITICAL SECURITY FIX: Secure ton_purchases table
-- Remove overly permissive policies that expose all purchase data

-- Drop dangerous policies that allow public access to all purchase data
