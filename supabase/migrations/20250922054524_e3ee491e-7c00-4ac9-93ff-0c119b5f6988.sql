-- CRITICAL SECURITY FIX: Secure telegram_users table to prevent data theft - Phase 2
...
-- Step 3: Update the existing safe_user_profiles view to maintain existing structure
-- First drop and recreate to avoid column conflicts
